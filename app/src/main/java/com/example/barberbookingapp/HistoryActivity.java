...
import com.example.barberbookingapp.Adapter.MyHistoryAdapter;
import com.example.barberbookingapp.Common.Common;
import com.example.barberbookingapp.Model.BookingInformation;
import com.example.barberbookingapp.Model.EventBus.UserBookingLoadEvent;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    private void loadUserInformationBooking() {
        ...
        //PATH /User/+6281232894725/Booking
    ...
    public void displayData(UserBookingLoadEvent event)
    {
        if(event.isSuccess())
        {
            ...
            txtHistory.setText(new StringBuilder("HISTORY(")
